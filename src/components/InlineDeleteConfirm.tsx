...
export default function InlineDeleteConfirm({ onConfirm, onCancel }: InlineDeleteConfirmProps): React.ReactElement {
  return (
    <div className="quick-edit-card quick-edit-card--danger">
      <div className="quick-edit-body quick-edit-confirm-message">Delete this note? This can't be undone.</div>
      <div className="quick-edit-footer quick-edit-footer--confirm">
        <div className="quick-edit-actions">
          ...
          <button type="button" className="quick-edit-btn quick-edit-btn-danger" onClick={onConfirm}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
